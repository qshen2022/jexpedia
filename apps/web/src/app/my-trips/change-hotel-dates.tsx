...
export function ChangeHotelDatesButton({
  ...
  const handleConfirm = async () => {
    ...
    try {
      const result = await apiClient.modifyHotelDates(bookingId, newCheckIn, newCheckOut);
      ...
      setError("Failed to change hotel dates.");
    }
    setModifying(false);
  };
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-sm">
        <DialogHeader>
          ...
          <DialogDescription>
            Current:{" "}
            {new Date(currentCheckIn).toLocaleDateString("en-US", { month: "short", day: "numeric" })}{" "}
            -{" "}
            {new Date(currentCheckOut).toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" })}
          </DialogDescription>
        </DialogHeader>
